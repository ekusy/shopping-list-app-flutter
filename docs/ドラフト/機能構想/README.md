...
| [06-AI商品提案（オンデマンド）.md](./06-AI商品提案（オンデマンド）.md) | 料理名・用途を入力して AI が商品を提案、選択してリストに追加 | 新規（AI提案機能とは別ユースケース） | Phase 2〜 |
...
- **06 AI商品提案はデータ面では独立**（履歴データに依存しない）ため、
  AI 提案 Phase 0 の完了を待たずに着手できる。Gemini 呼び出し基盤（`gemini_client.ts`）を
  流用する点のみ緩やかに関連する。
